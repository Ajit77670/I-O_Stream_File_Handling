...
public class I_O_Streams_in_Java {
    ...
    public static void main(String[] args) {
        ...
        try {
            try (FileOutputStream fs = new FileOutputStream("C://Users//Ajith Kumar//MyJava//Test.txt")) {  // Creating object for FileOutputStream for writting the files.
